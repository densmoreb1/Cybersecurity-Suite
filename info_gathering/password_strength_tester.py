...
sg.popup(""" The longer a password is the better it is to protect against brute force attacks """)
sg.popup(""" A regular computer nowdays can guess passwords at about 30 million guesses a second """)
sg.popup("""  """)
